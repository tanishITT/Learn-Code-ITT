...
class DivisorCounterTest {
    ...
    class ValidNumbers {
        ...
        void oneDivisorForOne() {
            assertEquals(1, DivisorCounter.countDivisors(1));
        }
        ...
        void primesHaveTwoDivisors(final int prime) {
            assertEquals(2, DivisorCounter.countDivisors(prime));
        }
    ...
    class InvalidNumbers {
        ...
        void zeroThrowsException() {
            assertThrows(IllegalArgumentException.class,
                    () -> DivisorCounter.countDivisors(0));
        }
        ...
        void negativeNumberThrowsException() {
            assertThrows(IllegalArgumentException.class,
                    () -> DivisorCounter.countDivisors(-5));
        }
        ...
        void exceptionMessageContainsInvalidNumber() {
            final IllegalArgumentException exception = assertThrows(
                    ...
                    () -> DivisorCounter.countDivisors(-10));
